...
Rails.application.configure do
  ...
  # The constrained runtime may opt in temporarily while a matching frontend artifact is prepared.
  config.assets.compile = ENV["OPENPROJECT_ASSETS_COMPILE"] == "true"
